...
const MultiSelectComponent = /*#__PURE__*/_react.default.forwardRef((props, currentRef) => {
  ...
  const [scaleAnim] = (0, _react.useState)(new _reactNative.Animated.Value(0));
  const [translateXAnim] = (0, _react.useState)(new _reactNative.Animated.Value(0));
  const [translateYAnim] = (0, _react.useState)(new _reactNative.Animated.Value(0));
  const animatingRef = (0, _react.useRef)(false);
  const measuredHeightRef = (0, _react.useRef)(0);
  const {
    width: W,
    height: H
  ...
  const animateIn = (0, _react.useCallback)(() => {
    ...
    const totalTranslateY = -(((position === null || position === void 0 ? void 0 : position.height) ?? 0) + (measuredHeightRef.current || maxHeight)) / 2 + animationOffsetY;
    translateYAnim.setValue(totalTranslateY);
    const totalTranslateX = -(((position === null || position === void 0 ? void 0 : position.width) ?? 0) / 2) + animationOffsetX;
    ...
    _reactNative.Animated.parallel([_reactNative.Animated.timing(fadeAnim, {
      ...
      useNativeDriver: true,
      easing: _reactNative.Easing.out(_reactNative.Easing.ease)
    }), _reactNative.Animated.timing(translateXAnim, {
      toValue: 0,
      duration: animationDuration,
      useNativeDriver: true,
      easing: _reactNative.Easing.out(_reactNative.Easing.ease)
  ...
  }, [animationDuration, animationEnabled, animationOffsetX, animationOffsetY, fadeAnim, maxHeight, position === null || position === void 0 ? void 0 : position.height, position === null || position === void 0 ? void 0 : position.width, scaleAnim, translateXAnim, translateYAnim]);
  const animateOut = (0, _react.useCallback)(callback => {
    ...
    _reactNative.Animated.parallel([_reactNative.Animated.timing(fadeAnim, {
      ...
      toValue: -(((position === null || position === void 0 ? void 0 : position.width) ?? 0) / 2) + animationOffsetX,
      duration: animationDuration,
      useNativeDriver: true,
      easing: _reactNative.Easing.in(_reactNative.Easing.ease)
    }), _reactNative.Animated.timing(translateYAnim, {
      toValue: -(((position === null || position === void 0 ? void 0 : position.height) ?? 0) + (measuredHeightRef.current || maxHeight) / 2) + animationOffsetY,
      duration: animationDuration,
      useNativeDriver: true,
      easing: _reactNative.Easing.in(_reactNative.Easing.ease)
    })]).start(() => {
  ...
  const showOrClose = (0, _react.useCallback)(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [disable, keyboardHeight, visible, _measure, data, searchText, onFocus, onBlur, animateIn, animateOut]);
  ...
  const onSelect = (0, _react.useCallback)(item => {
    ...
    const index = newCurrentValue.findIndex(e => e === (0, _get3.default)(item, valueField));
    if (index > -1) {
      newCurrentValue.splice(index, 1);
    } else {
      if (maxSelect) {
        if (newCurrentValue.length < maxSelect) {
          newCurrentValue.push((0, _get3.default)(item, valueField));
        }
      } else {
        newCurrentValue.push((0, _get3.default)(item, valueField));
      }
  ...
  const _renderDropdown = () => {
    ...
    }, selectedTextProps), placeholder), renderRightIcon ? renderRightIcon(visible) : /*#__PURE__*/_react.default.createElement(_reactNative.Image, {
      source: ic_down,
  ...
  const checkSelected = (0, _react.useCallback)(item => {
    const index = currentValue.findIndex(e => e === (0, _get3.default)(item, valueField));
    return index > -1;
  ...
  const _renderModal = (0, _react.useCallback)(() => {
    ...
    return null;
  }, [visible, search, position, keyboardHeight, maxHeight, minHeight, dropdownPosition, keyboardAvoiding, showOrClose, styleContainerVertical, backgroundColor, containerStyle, styleHorizontal, _renderList, fadeAnim, scaleAnim, translateXAnim, translateYAnim]);
  const _renderInvisibleDropdown = (0, _react.useCallback)(() => {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      ...
      style: _styles.styles.flexShrink
    }, renderSearch(), listData && listData.length > 0 ? listData.map((item, index) => _renderItem({
      item,
      index
    })) : null));
  }, [position, maxHeight, minHeight, styleHorizontal, containerStyle, renderSearch, listData, _renderItem]);
  const unSelect = item => {
    if (!disable) {
      onSelect(item);
    }
  ...
  const _renderItemSelected = inside => {
    const list = data.filter(e => {
      const check = value === null || value === void 0 ? void 0 : value.indexOf((0, _get3.default)(e, valueField));
      if (check !== -1) {
        return e;
      }
    });
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      ...
      if (renderSelectedItem) {
        return /*#__PURE__*/_react.default.createElement(_reactNative.TouchableWithoutFeedback, {
          testID: (0, _get3.default)(e, itemTestIDField || labelField),
          accessible: !!accessibilityLabel,
          accessibilityLabel: (0, _get3.default)(e, itemAccessibilityLabelField || labelField),
          key: (0, _get3.default)(e, labelField),
          onPress: () => unSelect(e)
        ...
        }, (0, _get3.default)(e, labelField)), /*#__PURE__*/_react.default.createElement(_reactNative.Text, {
  ...
  const _renderInside = () => {
    return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      ...
      ref: ref,
      onLayout: _measure
    }, _renderDropdownInside(), _renderModal(), _renderInvisibleDropdown());
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    ref: ref,
    onLayout: _measure
  }, _renderDropdown(), _renderModal(), _renderInvisibleDropdown()), (!visible || alwaysRenderSelectedItem) && visibleSelectedItem && _renderItemSelected(false));
});
