...
const DropdownComponent = /*#__PURE__*/_react.default.forwardRef((props, currentRef) => {
  ...
  // Added for animation
  const [dynamicWidth, setDynamicWidth] = (0, _react.useState)(0);
  ...
  const animateIn = (0, _react.useCallback)(() => {
    ...
    const totalTranslateY = -(((position === null || position === void 0 ? void 0 : position.height) ?? 0) + measuredHeightRef.current / 2) + animationOffsetY;
    translateYAnim.setValue(totalTranslateY);
    const totalTranslateX = -(((dynamicWidth || (position === null || position === void 0 ? void 0 : position.width)) ?? 0) / 2) + animationOffsetX;
  ...
  }, [animationDuration, animationEnabled, animationOffsetX, animationOffsetY, dynamicWidth, fadeAnim, position === null || position === void 0 ? void 0 : position.height, position === null || position === void 0 ? void 0 : position.width, scaleAnim, translateXAnim, translateYAnim]);
  const animateOut = (0, _react.useCallback)(callback => {
    ...
    _reactNative.Animated.parallel([_reactNative.Animated.timing(fadeAnim, {
      ...
      toValue: -(((dynamicWidth || (position === null || position === void 0 ? void 0 : position.width)) ?? 0) / 2) + animationOffsetX,
      duration: animationDuration,
      useNativeDriver: true,
      easing: _reactNative.Easing.in(_reactNative.Easing.ease)
    }), _reactNative.Animated.timing(translateYAnim, {
      toValue: -(((position === null || position === void 0 ? void 0 : position.height) ?? 0) + measuredHeightRef.current / 2) + animationOffsetY,
      duration: animationDuration,
      useNativeDriver: true,
      easing: _reactNative.Easing.in(_reactNative.Easing.ease)
    })]).start(() => {
  ...
  const _measure = (0, _react.useCallback)(e => {
    ...
    if (e) {
      ...
      const layoutWidth = (e === null || e === void 0 ? void 0 : (_e$nativeEvent = e.nativeEvent) === null || _e$nativeEvent === void 0 ? void 0 : (_e$nativeEvent$layout = _e$nativeEvent.layout) === null || _e$nativeEvent$layout === void 0 ? void 0 : _e$nativeEvent$layout.width) || 0;
  ...
  const scrollIndex = (0, _lodash.debounce)((0, _react.useCallback)(() => {
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    ...
    ref: ref,
    onLayout: _measure
  }, _renderDropdown(), _renderModal(), _renderInvisibleDropdown());
});
